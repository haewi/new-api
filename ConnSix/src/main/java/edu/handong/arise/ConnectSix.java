...
//	}
	 ...
	 * @return The String that contains the location of the opponent's move. The locations will be separated with the delimiter ':'. 
	 * @throws ConnSixException Throws an exception that happens when the network connection failed.
	 */
	 ...
	 * @param position the location of the stat that the user is curious about.
	...
	private String readStones() throws ConnSixException {
		// TODO control win, lose situation
		byte[] numBytes = new byte[4];
		String result = null;
